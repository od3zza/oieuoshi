...
if (logoEl) {
  const logos = [
    "/assets/uoshi-logos/uoshi-logo-black (1).png",
    "/assets/uoshi-logos/uoshi-logo-black (2).png",
    "/assets/uoshi-logos/uoshi-logo-black (3).png",
    "/assets/uoshi-logos/uoshi-logo-black (4).png",
    "/assets/uoshi-logos/uoshi-logo-black (5).png",
    "/assets/uoshi-logos/uoshi-logo-black (6).png",
    "/assets/uoshi-logos/uoshi-logo-black (7).png",
    "/assets/uoshi-logos/uoshi-logo-black (8).png",
  ];
...
document.querySelectorAll('.carousel').forEach(carousel => {
    ...
    // Atualização suave com requestAnimationFrame
