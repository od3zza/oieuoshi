...
////////////////////////////////////////////////////////////////////////////////////
/* Sistema de Comentários com Vercel Functions */

// Configuração - URLs das Vercel Functions
const COMMENTS_CONFIG = {
  // URLs das Vercel Functions (serão automaticamente definidas baseadas no domínio atual)
  addCommentUrl: '/api/add-comment',
  getCommentsUrl: '/api/get-comments',
...
async function submitComment() {
  ...
  try {
    ...
    const response = await fetch(COMMENTS_CONFIG.addCommentUrl, {
      method: 'POST',
      headers: {
...
async function loadComments() {
  ...
  try {
    ...
    const url = `${COMMENTS_CONFIG.getCommentsUrl}?postId=${encodeURIComponent(COMMENTS_CONFIG.postId)}&limit=${COMMENTS_CONFIG.maxComments}`;
...
function displayComments(comments) {
  ...
  // Os comentários já vêm ordenados do backend
